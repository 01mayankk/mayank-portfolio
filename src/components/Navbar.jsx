            ...
            >
                <div className={cn(
                    ...
                    <Link to="hero" smooth={true} duration={500} className="text-xl md:text-2xl font-bold cursor-pointer font-heading tracking-tight group flex items-center gap-1 shrink-0">
                        <motion.span layout whileHover={{ y: -2 }} className="text-white group-hover:text-accent-emerald transition-colors">Mayank</motion.span>
                    ...
                    <div className="hidden md:flex items-center gap-8">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex items-center gap-4">
                                <motion.a
                                    whileHover={{ y: -2 }}
                                    href="https://github.com/01mayankk"
                                    target="_blank"
                                    rel="noreferrer"
                                ...
                                <motion.a
                                    whileHover={{ y: -2 }}
                                    href="https://www.linkedin.com/in/01mayank/"
                                    target="_blank"
                                    rel="noreferrer"
                                    className="text-text-muted hover:text-white transition-colors"
                                >
